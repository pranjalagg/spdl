##############################################################################################################
##############################################################################################################
########## This is an old version of the program before code refactoring. This version is kept      ##########
########## as is for reference purposes and in case the refactored code breaks and does not work    ##########
########## as expected.                                                                             ##########
##############################################################################################################
##############################################################################################################
